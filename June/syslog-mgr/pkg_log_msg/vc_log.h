...
#define LOG_EMERG(dbus, fmt, ...) LOG_LEVEL( dbus, emerg , fmt , ##__VA_ARGS__ )
#define LOG_ERROR(dbus, fmt, ...) LOG_LEVEL( dbus, error , fmt , ##__VA_ARGS__ )
#define LOG_WARN(dbus, fmt, ...) LOG_LEVEL( dbus, warn , fmt , ##__VA_ARGS__ )
#define LOG_INFO(dbus, fmt, ...) LOG_LEVEL( dbus, info , fmt , ##__VA_ARGS__ )
